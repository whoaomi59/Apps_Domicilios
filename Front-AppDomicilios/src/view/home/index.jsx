    ...
    <div>
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-end mt-5">
          <a
            class="py-2 px-2 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-green-300 bg-white text-green-500 hover:bg-green-500 hover:text-white"
            href="/login"
          >
            Ingresar
          </a>
        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center mt-20">
          <div>
            ...
            <div class="mt-7 grid gap-3 w-full sm:inline-flex">
              ...
              <a
                class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-300 hover:text-white"
                href="/shop/negocios"
              >
                Comprar
              </a>
